...
var paramTagProcessor = function (commentLine) {
    return parseCommonMethodTag(commentLine, TOKEN_PROCESSORS.PARAM_TAG.TOKEN);
};
...
var returnTagProcessor = function(commentLine) {
    return parseCommonMethodTag(commentLine, TOKEN_PROCESSORS.RETURN_TAG.TOKEN);
};
...
var throwsTagProcessor = function(commentLine) {
    return parseCommonMethodTag(commentLine, TOKEN_PROCESSORS.THROWS_TAG.TOKEN);
};
...
function parseCommonMethodTag(commentLine, tagToken) {
    var parts = {};
